# Atualiza os indicadores do painel CRK a partir da planilha mensal
# "Fundamentos Comissão e Produtividade" (.xlsm) do mês/ano atuais.
# Uso: dê 2 cliques no atalho "Atualizar Fundamentos.bat" (mesma pasta do projeto).
...
node import_fundamentos.js --arquivo $arquivo --data-referencia $dataReferencia --commit

# Atualiza a aba "Volumes Futuros" do painel CRK a partir da planilha
# "Acompanhamento Executiva Volumes Futuros - 40 PDVS" do mês/ano atuais.
# Uso: dê 2 cliques no atalho "Atualizar Volumes Futuros.bat" (mesma pasta do projeto).
...
$arquivo = Join-Path $pastaRelatorio "$mesNum - Acompanhamento Executiva Volumes Futuros - 40 PDVS.xlsx"
...
node import_volumes_futuros.js --arquivo $arquivo --data-referencia $dataReferencia --commit
